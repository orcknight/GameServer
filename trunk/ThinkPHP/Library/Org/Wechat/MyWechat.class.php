...
class MyWechat extends Wechat {
    ...
    protected function replyWelcomeActivity() {
        ...
        $picurl = "http://wechat.luobojianzhi.com/Public/promot/images/luoboqianbao.jpg";
        $url = "http://mp.weixin.qq.com/s/GuKk9rl8NzJG_em7nrOUkQ";
        $title = "【你见过会生钱的萝卜钱包吗？】";
        $desc = "你见过会生钱的萝卜钱包吗？！";

        $items = array(
            new NewsResponseItem($title, $desc, $picurl, $url),
            new NewsResponseItem('威海市2017年高校毕业生集中招聘，点击进入申请职位!', '', '', "http://wechat.luobojianzhi.com/index.php/home/job/categories/cId/1/type/9"),
        );
