...
class WalletController extends WtAuthController{
    ...
    public function getIncomeDetail(){
        ...
        $orderTypes="0,20";
        $nonSearchTypes = WalletEnum::ORDERTYPE_PROMOT_GASINS . "," . WalletEnum::ORDERTYPE_FINANCIAL_GAINS . "," . WalletEnum::ORDERTYPE_WAGE_GAINS;
    ...
    */
    public function getSalaryLog(){
        ...
        $decreaseType = WalletEnum::TYPE_DECREASE;
        $orderTypes="0,20";
        $searchTypes = WalletEnum::ORDERTYPE_WAGE_GAINS;
