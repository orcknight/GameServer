    ...
    public function doApply() {
        ...
        if(IS_POST){
            ...
            if($id)
            {
                ...
                ."',tel='".$data['tel']."',provinceName='".$data['province_name']
                ."',cityName='".$data['city_name']."',schoolName='".$data['school_name']
                ."' WHERE id='$id'";
                $this->trackLog("sql", $sql);
                $res = $db->execute($sql);
                ...
                ."provinceName,cityName,schoolName) VALUES('$wxid',0,'"
                ...
                if($chiefId) {
                    ...
                    if($arr)
                    {
                        ...
                        if($img_arr)
                        {
                            ...
                            $sql = "UPDATE ac_chief SET qrPath='".$img_arr['path']."' WHERE id='$chiefId'";
                            $this->trackLog("sql", $sql);
                            $res = $db->execute($sql);
                            $this->trackLog("res", $res);
                        }
