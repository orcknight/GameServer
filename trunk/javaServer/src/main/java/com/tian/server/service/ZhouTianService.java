...
/**
 * Created by PPX on 2017/9/21.
 */
public class ZhouTianService {
...
//
//            // 手阳明脉
//            "tongren r1"    :  ({"手阳明脉","肘髎穴", "QI:20:ADDPOT:100000","8000"}),
//            "tongren r2"    :  ({"手阳明脉","手五里穴", "QI:30:ADDPOT:100000","8000"}),
//            "tongren r3"    :  ({"手阳明脉","曲池穴", "QI:40:ADDPOT:100000","8000"}),
//            "tongren r4"    :  ({"手阳明脉","迎香穴", "QI:20:ADDPOT:100000","30000"}),
//            "tongren r5"    :  ({"手阳明脉","臂儒穴", "QI:30:ADDPOT:100000","8000"}),
//            "tongren r6"    :  ({"手阳明脉","巨骨穴", "QI:40:ADDPOT:100000","8000"}),
//            "tongren r7"    :  ({"手阳明脉","天鼎穴", "QI:50:ADDPOT:100000","8000"}),
//            "tongren r8"    :  ({"手阳明脉","扶突穴", "QI:60:ADDPOT:100000","8000"}),
//            "tongren r9"    :  ({"手阳明脉","口禾髎穴", "QI:30:ADDPOT:100000","8000"}),
//            "tongren r10"   :  ({"手阳明脉","合谷穴", "QI:30:ADDPOT:100000","8000"}),
//            "tongren r11"   :  ({"手阳明脉","二间穴", "QI:30:ADDPOT:100000","8000"}),
//            "tongren r12"   :  ({"手阳明脉","三间穴", "FOOD:30:ADDPOT:100000","8000"}),
//            "tongren r13"   :  ({"手阳明脉","商阳穴", "FOOD:20:ADDPOT:100000","8000"}),
//            "tongren r14"   :  ({"手阳明脉","阳溪穴", "FOOD:30:ADDPOT:100000","8000"}),
//            "tongren r15"   :  ({"手阳明脉","手三里穴", "FOOD:40:ADDPOT:100000","8000"}),
//            "tongren r16"   :  ({"手阳明脉","上廉穴", "WATER:20:ADDPOT:100000","8000"}),
//            "tongren r17"   :  ({"手阳明脉","下廉穴", "WATER:30:ADDPOT:100000","8000"}),
//            "tongren r18"   :  ({"手阳明脉","温溜穴", "WATER:40:ADDPOT:100000","8000"}),
//            "tongren r19"   :  ({"手阳明脉","偏历穴", "WATER:20:ADDPOT:100000","8000"}),
//
//            // 足阳明脉
...
//                case "MAR":
//                    me->add("jingmai/mar", p);
//                    break;
//                case "POT":
//                    me->add("jingmai/pot", p);
//                    break;
//                case "MINGSI":
//                    me->add("jingmai/reflect", p);
//                    break;
//                case "FOOD":
...
//                write(HIY "打通小周天奖励：十五万点潜能及一万点实战体会。\n" NOR);
//
//                // 系统通告
//                CHANNEL_D->do_channel(this_object(), "rumor", "恭喜" + HIY + me->name() + HIM "打通了" + HIR +
//                        "小周天经脉" + HIM "，功力突飞猛进。\n");
...
//                */
//            write(HIY "打通大小周天奖励：六十万点潜能及四万点实战体会。\n" NOR);
//
//            // 系统通告
//            CHANNEL_D->do_channel(this_object(), "rumor", "恭喜" + HIY + me->name() + HIM "打通了" + HIR +
//                    "全身大小周天经脉" + HIM "，功力已如神人。\n");
