...
<link rel="stylesheet" href="/Public/source/debug/styles/main.css?t=1482911928945">
                ...
                <div class="row no-gutter">
                    <div class="col-66 fc_lightGray">
                        ...
                        <p class="f12 pos_rela">
                            ...
                            {{if job.paytype}}
                                <span class="marg_left_10 paytype">{{#job.paytype}}</span>
                            {{/if}}
                        </p>
                    </div>
        ...
        <script>
                $(function () {
                    ...
                    $(document).on("pageInit", "#index", function(e, pageId, $page) {
                        ...
                        if(isNaN(cId) || !cId){
                            <?php if($cId == 0): ?>$.showPreloader('萝卜卫星定位中，请稍后...');
                                getH5Location();
                                cId =1;
                                initDefaultCity(cId);
                            <?php else: ?>
                                cId = <?php echo ($cId); ?>;
                                initDefaultCity(cId);<?php endif; ?>
                        } else {
                            $.ajax({
                                type: 'POST',
            ...
            <script  type='text/javascript' src='/Public/source/debug/scripts/home-job-detail.js' charset='utf-8'></script>
    </body>
</html>